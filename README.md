...
- Лицензия: ./LICENSE
- Артефакты 1С для SRS КМП4: `1c/core_subset` хранит выборку ключевых объектов УТ 10.3 (модули возвратов, перемещений, регистров), а внешняя обработка лежит в `1c/src/КМП4` (`Ext/ObjectModule.bsl`, формы и макеты XML). Выгрузка фиксирует текущее поведение обмена/форм и служит источником требований при подготовке нового SRS по потоку КМП4.
