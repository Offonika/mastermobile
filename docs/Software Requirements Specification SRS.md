Название: Software Requirements Specification (SRS) — Курьерская доставка с «Ходячим складом» · Версия: v0.3.3 · Дата: 2025-09-26 · Владелец: Операции / IT · Статус: Draft
Связанные документы:
...
### Changelog
- v0.3.3 — 2025-09-26 — non-breaking: добавлены стандартная шапка и changelog; технические требования не изменялись.
