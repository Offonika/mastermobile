Название: API‑Contracts — Unified (Walking Warehouse + Core Sync) · Версия: v1.1.3 · Дата: 2025-09-18 · Владелец: Арх/API · Статус: Approved
Связанные документы:
...
- [PRD — Тексты звонков Bitrix24.md](PRD — Тексты звонков Bitrix24.md)
...
### Changelog
- v1.1.3 — 2025-09-18 — non-breaking: приведена шапка к стандарту и добавлен changelog без изменения контрактов.