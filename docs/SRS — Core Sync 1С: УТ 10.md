...
Версия: 1.0.2 (синхронизировано с 00‑Core v1.3.3)
 Дата: 20.09.2025
 Владелец: Операции / IT
Связанные документы: PRD Core Sync v1.1.2 (18.09.2025), ONE‑PAGER (финал), API‑Contracts v1.0.0, ER Freeze v0.6.5
...
9. Данные и маппинг (см. ER Freeze v0.6.5)
