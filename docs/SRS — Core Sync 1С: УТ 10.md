...
Связанные документы: PRD Core Sync v1.1.2 (18.09.2025), ONE‑PAGER (финал), API‑Contracts v1.1.0, ER Freeze v0.6.5
...
Контракт v1.1.0 опубликован в `openapi.yaml` и покрывает три домена: `returns`, `b24-calls`, `walking-warehouse`, а также системные проверки. Контракт синхронизирован с FastAPI-службой; любые изменения требуют обновления OpenAPI и SRS.
