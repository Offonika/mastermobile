Название: SRS — Core Sync 1С: УТ 10.3 ↔ УТ 11 (без простоя) · Версия: v1.0.1 · Дата: 2025-09-18 · Владелец: Операции / IT · Статус: Draft
Связанные документы:
...
### Changelog
- v1.0.1 — 2025-09-18 — non-breaking: добавлены стандартизированная шапка и changelog без изменения требований.
