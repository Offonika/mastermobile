Название: ONE-PAGER — «Тексты всех звонков за 60 дней из Bitrix24» · Версия: v1.0.0 · Дата: 2025-09-19 · Владелец: Интеграции · Статус: Draft
Связанные документы:
...
### Changelog
- v1.0.0 — 2025-09-19 — non-breaking: добавлены единая шапка и changelog, содержание one-pager не менялось.
