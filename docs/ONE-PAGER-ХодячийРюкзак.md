...
Дата: 17.09.2025
Что мы делаем
Запускаем прозрачный процесс курьерской доставки и возвратов на связке MasterMobile Middleware ↔ Bitrix24 ↔ действующая 1С без больших переделок конфигурации.
Курьер — мобильный Bitrix24 (наш виджет).


Менеджер — рабочее место в 1С.
