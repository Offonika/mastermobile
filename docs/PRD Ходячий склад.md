Название: PRD «Ходячий склад» · Версия: v1.3.2 · Дата: 2025-09-18 · Владелец: Продакт · Статус: Approved
Связанные документы:
...
### Changelog
- v1.3.2 — 2025-09-18 — non-breaking: добавлены единая шапка и changelog; продуктовый объём без изменений.