...
Кто ставит и как фиксируется return_rejected.
 ...
 body: {reason_code: no_defect_found|other, reason_note?, items:[{line_id, sku, qty}], actor:{id_1c, fio}} — схема фиксируется в API‑Contracts §3.6.
...
Синхронизировали с ER Freeze v0.6.5 (валюта, индексы, валидаторы возвратов, таблицы call_exports/call_records).
