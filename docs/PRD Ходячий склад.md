...
B2. Возврат денег клиенту. По умолчанию — безнал через бухгалтерию. Наличными «у двери» — только по роли и лимиту; оформляется РКО из «Деньги в пути» с привязкой к возврату.
...
Ретенции: фото ≤90 дн, гео ≤30 дн, логи 30–180 дн, idempotency‑keys 72 ч.
...
Выровняли Retention: idempotency‑keys 72 ч.
