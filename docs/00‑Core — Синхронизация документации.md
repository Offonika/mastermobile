...
Назначение. Единая «шина» правил и ссылочный пакет для двух проектов — «Ходячий рюкзак» (мобильная доставка и возвраты) и «Core Sync» (связка действующей 1С с MasterMobile Middleware). Документ фиксирует общий стиль API, словари статусов, версионирование, источники истины (SoT), цельную ER‑модель и ворота релизов. Все продуктовые PRD/SRS ссылаются на данный документ и не дублируют его содержимое.

### Version Map (на 21.09.2025)
| Поток | PRD | SRS | Привязки |
| --- | --- | --- | --- |
| Core Sync (1С ↔ MasterMobile Middleware) | v1.1.2 (18.09.2025) | v1.0.3 (27.09.2025) | 00‑Core v1.3.6, API‑Contracts v1.1.0, ER Freeze v0.6.4 |
