Название: 00‑Core — Синхронизация документации · Версия: v1.3.1 · Дата: 2025-09-18 · Владелец: Архитектура · Статус: Approved
Связанные документы:
...
### Changelog
- v1.3.1 — 2025-09-18 — non-breaking: приведена шапка к единому формату и добавлен раздел Changelog.
