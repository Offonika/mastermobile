...
00‑Core — Синхронизация документации (v1.3.3)
Дата обновления: 27.09.2025
Связанные артефакты: API‑Contracts v1.1.1, SRS Core Sync v1.0.3

> Обновление 27.09.2025. Версия карты синхронизирована с API‑Contracts v1.1.1 и SRS Core Sync v1.0.3; подтверждено соответствие `plan.md` и PRD «Ходячий склад» после добавления операции reject.
...
| --- | --- | --- | --- |
| Core Sync (УТ 10.3↔11) | v1.1.2 (18.09.2025) | v1.0.3 (27.09.2025) | 00‑Core v1.3.2, API‑Contracts v1.1.1, ER Freeze v0.6.5 |
| B24 Batch-Transcribe | v1.0.0 (19.09.2025) | v1.0.0 (21.09.2025) | 00‑Core v1.3.1, API‑Contracts v1.1.1, ER Freeze v0.6.4 |
...
Статусы и переходы согласованы с владельцами API‑Contracts v1.1.1 (docs/API‑Contracts.md).
...
- 27.09.2025 — Добавлен контракт операции reject: API‑Contracts обновлён до v1.1.1, SRS Core Sync до v1.0.3; сверены `plan.md` и PRD «Ходячий склад», ссылки раздела 1 приведены к актуальному baseline.
