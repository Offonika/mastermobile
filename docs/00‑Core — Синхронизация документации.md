...
Связанные артефакты: API‑Contracts v1.0.0, API‑Contracts v1.1.3 (Bitrix24 телефония), SRS Core Sync v1.0.2, PRD — Тексты звонков Bitrix24 v1.0.0, SRS — Тексты звонков Bitrix24 (выгрузка за 60 дней) v1.0.0
...
| B24 Batch-Transcribe | v1.0.0 (19.09.2025) | v1.0.0 (21.09.2025) | 00‑Core v1.3.1, API‑Contracts v1.1.3, ER Freeze v0.6.4 |
...
## Changelog
- 21.09.2025 — Добавлена Version Map с Batch-Transcribe (PRD/SRS) и привязками к 00‑Core v1.3.1, API‑Contracts v1.1.3.
