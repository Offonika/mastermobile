...
Связанные артефакты: API‑Contracts v1.1.0, SRS Core Sync v1.0.2

> Обновление 26.09.2025. Версия карты синхронизирована с API‑Contracts v1.1.0 после аудита ссылок на v1.1.3.
