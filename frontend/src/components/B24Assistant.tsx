...
const prompts: StartScreenPrompt[] = [
  {
    label: 'Возврат',
    prompt:
      'Оформи возврат по заказу №{{номер_заказа}}: причина — {{причина_возврата}}, состояние товара — {{состояние_товара}}.',
    icon: 'search',
  },
  {
    label: 'Гарантия',
    prompt:
      'Уточни условия гарантии для устройства {{модель}}. Номер обращения — {{номер_обращения}}, дата покупки — {{дата_покупки}}.',
    icon: 'circle-question',
  },
  {
    label: 'Лид',
    prompt:
      'Подготовь сводку по лиду {{название_компании}}: запрос — {{запрос}}, контакт — {{контактное_лицо}}, статус — {{статус}}.',
    icon: 'document',
  },
];
